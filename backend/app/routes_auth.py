...
#         # Créer l'utilisateur avec compte inactif
#         activation_token = str(uuid.uuid4())
#         activation_expiry = datetime.utcnow() + timedelta(hours=24)  # token valable 24h
...
#         activation_link = url_for("auth.activate", token=activation_token, _external=True)
#         msg = Message(
...
#                  f"<a href='{activation_link}'>Activer</a>"
#         )
#         mail.send(msg)
